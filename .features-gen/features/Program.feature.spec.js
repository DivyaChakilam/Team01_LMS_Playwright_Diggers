...
test.describe('Program page validation', () => {
  ...
  test.skip('Verify Admin is able to click \'No\'', { tag: ['@skip'] }, async ({ Given, When, Then }) => { 
    await Given('Admin is on Program Confirm Deletion Page after selecting a program to delete'); 
    await When('Admin clicks on nobutton"No" button'); 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":27,"pickleLine":24,"skipped":true,"tags":["@skip"],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given Admin logs in to LMS application and lands on home page","isBg":true},{"pwStepLine":8,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the \"Program\" Navigation bar in the Header","isBg":true},{"pwStepLine":28,"gherkinStepLine":25,"keywordType":"Context","textWithKeyword":"Given Admin is on Program Confirm Deletion Page after selecting a program to delete"},{"pwStepLine":29,"gherkinStepLine":26,"keywordType":"Action","textWithKeyword":"When Admin clicks on nobutton\"No\" button"},{"pwStepLine":30,"gherkinStepLine":27,"keywordType":"Outcome","textWithKeyword":"Then Admin can see Confirmation form disappears"}]},
